<template>
  <div class="home-container">
    ...
    <div class="main-content" :style="s.mainContent">
      ...
      <section class="hero-section" :style="s.heroSection">
        <div class="hero-left" :style="s.heroLeft">
          <div class="tag-row" :style="s.tagRow">
            <span class="orange-tag" :style="s.orangeTag">Offline Multi-Agenten-Simulationsengine</span>
            <span class="version-text" :style="s.versionText">/ v0.1-Vorschau</span>
          </div>

          <h1 class="main-title" :style="s.mainTitle">
            Lade ein beliebiges Dokument hoch<br>
            <span class="gradient-text" :style="s.gradientText">Sage voraus, was als nächstes passiert</span>
          </h1>

          <div class="hero-desc" :style="s.heroDesc">
            <p :style="s.heroDescP">
              Aus einem einzigen Dokument extrahiert <span :style="s.highlightBold">MiroFish Offline</span> Realitätskerne und erschafft eine Parallelwelt mit <span :style="s.highlightOrange">autonomen KI-Agenten</span> – vollständig auf deiner eigenen Hardware. Injiziere Variablen, beobachte emergentes Verhalten und finde <span :style="s.highlightCode">„lokale Optima"</span> in komplexen sozialen Dynamiken.
            </p>
            <p class="slogan-text" :style="s.sloganText">
              Deine Daten verlassen niemals deinen Rechner. Die Zukunft wird lokal simuliert<span :style="s.blinkingCursor">_</span>
            </p>
          </div>
      ...
      <!-- Dashboard: Zweispaltiges Layout -->
      <section class="dashboard-section" :style="s.dashboardSection">
        ...
        <div class="left-panel" :style="s.leftPanel">
          ...
          <p class="section-desc" :style="s.sectionDesc">
            Lokale Vorhersage-Engine im Standby-Modus. Lade unstrukturierte Daten hoch, um eine Simulation zu starten.
          </p>
          ...
          <div class="steps-container" :style="s.stepsContainer">
            <div class="steps-header" :style="s.stepsHeader">
               <span :style="s.diamondIcon">◇</span> Workflow-Ablauf
            </div>
          ...
          <div class="console-box" :style="s.consoleBox">
            ...
            <div :style="s.consoleSection">
              ...
              <div :style="s.inputWrapper">
                <textarea v-model="formData.simulationRequirement" :style="s.codeInput" placeholder="// Beschreibe dein Simulationsziel oder deine Vorhersageaufgabe in natürlicher Sprache" rows="6" :disabled="loading"></textarea>
                <div :style="s.modelBadge">Engine: Ollama + Neo4j (lokal)</div>
              </div>
            </div>
...
const steps = [
  { num: '01', title: 'Graph-Aufbau', desc: 'Realitätskerne aus dem Dokument extrahieren, Wissensgraph mit Neo4j + GraphRAG erstellen' },
  { num: '02', title: 'Umgebungs-Setup', desc: 'Agenten-Personas generieren, Simulationsparameter über lokales Ollama LLM konfigurieren' },
  { num: '03', title: 'Simulation', desc: 'Multi-Agenten-Simulation lokal ausführen mit dynamischen Speicheraktualisierungen und emergentem Verhalten' },
  { num: '04', title: 'Bericht', desc: 'Der Berichts-Agent analysiert die Simulationsergebnisse und erstellt einen detaillierten Vorhersagebericht' },
  { num: '05', title: 'Interaktion', desc: 'Chatte mit einem beliebigen Agenten aus der simulierten Welt oder diskutiere Ergebnisse mit dem Berichts-Agenten' },
]
...
<!-- Stile werden aus Home.css importiert -->
