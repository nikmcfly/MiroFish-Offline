<template>
  <div class="home-container">
    ...
    <nav class="navbar" :style="s.navbar">
      <div class="nav-brand" :style="s.navBrand">{{ brand.displayName }}</div>
      <div class="nav-links" :style="s.navLinks">
        <a v-if="brand.githubUrl" :href="brand.githubUrl" target="_blank" class="github-link" :style="s.githubLink">
      ...
      <section class="hero-section" :style="s.heroSection">
        ...
        <div class="hero-right" :style="s.heroRight">
          <div class="logo-container" :style="s.logoContainer">
            <img :src="brand.logoLeft" :alt="`${brand.name} logo`" :style="s.heroLogo" />
          </div>
...
const s = reactive({
  ...
  orangeTag: { background: 'var(--brand-accent)', color: '#fff', padding: '4px 10px', fontWeight: '700', letterSpacing: '1px', fontSize: '0.75rem' },
  ...
  highlightOrange: { color: 'var(--brand-accent)', fontWeight: '700', fontFamily: mono },
  ...
  sloganText: { fontSize: '1.2rem', fontWeight: '520', color: '#000', letterSpacing: '1px', borderLeft: '3px solid var(--brand-accent)', paddingLeft: '15px', marginTop: '20px' },
  blinkingCursor: { color: 'var(--brand-accent)', fontWeight: '700' },
  decorationSquare: { width: '16px', height: '16px', background: 'var(--brand-accent)' },
  ...
  scrollDownBtn: { width: '40px', height: '40px', border: '1px solid #E5E5E5', background: 'transparent', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', color: 'var(--brand-accent)', fontSize: '1.2rem' },
  ...
  statusDot: { color: 'var(--brand-accent)', fontSize: '0.8rem' },
