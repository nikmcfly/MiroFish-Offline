...
# Path: repository .env (relative to backend/app/config.py)
...
class Config:
    ...
    # Flask configuration
    SECRET_KEY = os.environ.get('SECRET_KEY', 'signalquay-secret-key')
    ...
    NEO4J_PASSWORD = os.environ.get('NEO4J_PASSWORD', 'signalquay')
