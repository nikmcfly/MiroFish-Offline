...
def generate_report():
    ...
    try:
        ...
        # Grab storage from app context before spawning thread
        ...
        def run_generate():
            try:
                ...
                # Create Report Agent with GraphToolsService
...
def check_report_status(simulation_id: str):
    ...
    Used by the frontend to determine whether to unlock Interview functionality
...
def get_console_log(report_id: str):
    ...
    This is different from the structured JSON log returned by the agent-log endpoint;
